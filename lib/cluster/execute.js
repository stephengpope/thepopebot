...
import { stopContainer as dockerStopContainer, removeContainer, runClusterWorkerContainer, resolveHostPath, listContainers, saveContainerLogs } from '../tools/docker.js';
...
export async function stopRoleContainers(cluster, role) {
  ...
  for (const c of containers) {
    ...
    await saveContainerLogs(c.name);
